<html lang="fr" xmlns="http://www.w3.org/1999/xhtml" xmlns:v="urn:schemas-microsoft-com:vml" xmlns:o="urn:schemas-microsoft-com:office:office"><head>
  <meta charset="UTF-8">
  ...
  <!--[if !mso]><!-->
  <link href="https://fonts.googleapis.com/css?family=Bree+Serif|Ubuntu|Dancing+Script|Droid+Sans|Lato|Lobster|Montserrat|Open+Sans|Pacifico|Raleway|Roboto|Source+Sans+Pro|Titillium+Web&amp;subset=cyrillic,cyrillic-ext,greek,greek-ext,latin-ext,vietnamese" rel="stylesheet" type="text/css">
  <style type="text/css">
      ...
      <table align="center" cellpadding="0" cellspacing="0">
        <tbody><tr>
          <td align="center" class="fix-space-td-img">
            <div>
                        <img style="display: block;" width="131" height="131" src="https://ki-oui.ythepaut.com/ressources/img/logo.png">
            </div>
          </td>
        </tr>
      </tbody></table>
  ...
  <tbody><tr>
    <td align="left">
      <h1 style="font-family: Arial;
        ...
        color: #393939;
        margin: 0;text-align: center;mso-line-height-rule: exactly;"><span style="font-size: 33px; line-height: 40px; mso-line-height-rule: exactly;"><strong>