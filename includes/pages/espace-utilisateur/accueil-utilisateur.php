                ...
                <div class="col panel-outline">
                    ...
                    <?php } ?>
                        ...
                        foreach($files as $file){
                            ...
                            //Colonne Action
                            $table .=  "<td>" . "<a href='#' data-toggle='modal' data-target='#modalChangeSalt' onclick='editModalChangeSalt(" . $file["id"] . ")'><i class='fas fa-redo edit'></i></a>" 
                                                    . "&nbsp; &nbsp; &nbsp;" .
...
include("./includes/pages/modals/change-salt.php");
?>
