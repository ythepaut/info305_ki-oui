        <div class="col user-nav mobile">
            <ul class="white">
                ...
                <li <?php if (isset($sousPage) && $sousPage == "administration") { echo(" class='active'"); } ?>><a href="/espace-utilisateur/administration/#/statistiques"><i class="fas fa-user-shield"></i> &nbsp;&nbsp;&nbsp; Administration</a></li>
                <?php } ?>
            </ul>
        </div>