                    ...
                    <div class="col-lg-8">
                        ...
                        <form action="<?php echo(getSrc('./includes/classes/actions.php')); ?>" method="POST" class="ajax">
                            ...
                            <div class="input-group mb-3">
                                ...
                                <input type="password" name="old_password" class="form-control" placeholder="Ancien mot de passe" aria-describedby="icon_change-password_oldpassword" required />
                            </div>
                            ...
                            <div class="input-group mb-3">
                                ...
                                <input type="text" name="new_password" class="form-control" placeholder="Nouveau mot de passe" aria-describedby="icon_change-password_newpassword" required />
                            </div>
                            ...
                            <div class="input-group mb-3">
                                ...
                                <input type="text" name="new_password_bis" class="form-control" placeholder="Réécriver le nouveau mot de passe" aria-describedby="icon_change-password_confirmnewpassword" required />
                            </div>
